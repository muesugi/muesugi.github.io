    ...
    return (
      <React.Fragment>
        <div className="shortbio">
          Moie is a Computer Science and Comparative Literature student who
          likes learning and creating at the intersection of technology and
          culture.
          <br />
          This is a Design\/UI portfolio that she created in Fall 2017 for her
          User Interfaces and Experiences class.
        </div>
        <Link to={this.props.internalLink} className="ui-portfolio-summary">
          ...
          {this.props.date ? (
            <div className="portfolio-date">{this.props.date}</div>
          ) : (
            ""
          )}
        </Link>
