...
const MainNavigation = ({ showUiPortfolio }) => (
  <div className="main-nav">
    ...
    <nav className="nav-right desktop-nav">
      ...
      <NavLink to="/resume" className="main-nav-link">
        resume
      </NavLink>
      {showUiPortfolio ? (
        <NavLink to="/ui-portfolio" className="main-nav-link">
          portfolio
        </NavLink>
      ) : (
        <NavLink to="/portfolio" className="main-nav-link">
          portfolio
        </NavLink>
      )}
